...
export namespace FlipCoinEvent {
...
export namespace GuessNumberEvent {
  export type InputTuple = [
    token: AddressLike,
    amount: BigNumberish,
    number: BigNumberish,
...
export interface Casino extends BaseContract {
  ...
  guessNumber: TypedContractMethod<
    [
      token: AddressLike,
      amount: BigNumberish,
      number: BigNumberish,
  ...
  getEvent(
    ...
    FlipCoinEvent.InputTuple,
    FlipCoinEvent.OutputTuple,
    FlipCoinEvent.OutputObject
  >;
  getEvent(
    key: "GuessNumber"
  ): TypedContractEvent<
    GuessNumberEvent.InputTuple,
    GuessNumberEvent.OutputTuple,
    GuessNumberEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "FlipCoin(address,uint256,uint256,bool)": TypedContractEvent<
      FlipCoinEvent.InputTuple,
      FlipCoinEvent.OutputTuple,
      FlipCoinEvent.OutputObject
    >;
    FlipCoin: TypedContractEvent<
      FlipCoinEvent.InputTuple,
      FlipCoinEvent.OutputTuple,
      FlipCoinEvent.OutputObject
    >;

    "GuessNumber(address,uint256,uint256,bool)": TypedContractEvent<
      GuessNumberEvent.InputTuple,
      GuessNumberEvent.OutputTuple,
      GuessNumberEvent.OutputObject
    >;
    GuessNumber: TypedContractEvent<
      GuessNumberEvent.InputTuple,
      GuessNumberEvent.OutputTuple,
      GuessNumberEvent.OutputObject
    >;
