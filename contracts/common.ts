...
type _TypechainAOutputTuple<T> = T extends TypedContractEvent<
  infer _U,
  infer W
>
  ? W
  : never;
type _TypechainOutputObject<T> = T extends TypedContractEvent<
  infer _U,
  infer _W,
  infer V
>
...
export interface TypedEventLog<TCEvent extends TypedContractEvent>
  ...
  args: _TypechainAOutputTuple<TCEvent> & _TypechainOutputObject<TCEvent>;
}
...
export type TypedListener<TCEvent extends TypedContractEvent> = (
  ...listenerArg: [
    ..._TypechainAOutputTuple<TCEvent>,
